          ...
          {faqs.map((faq, index) => (
            ...
            >
              ...
              <p className="text-foreground">
                {index === 2 ? (
                  <>
                    Absolutely! While our team works remotely from London, we
                    can arrange face-to-face meetings at our{" "}
                    <Link
                    ...
                    offices. Both cities are easily accessible from London by
                    train in under 2.5 hours.
                  </>
                ) : (
                  faq.answer
                )}
