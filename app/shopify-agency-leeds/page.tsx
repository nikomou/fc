          ...
          {faqs.map((faq, index) => (
            ...
            >
              ...
              <p className="text-foreground">
                {index === 1 ? (
                  <>
                    Absolutely! While we don&apos;t have a physical office in
                    Leeds, our{" "}
                    <Link
                    ...
                    offices are easily accessible. We&apos;re happy to travel to
                    Leeds for important meetings, or you can visit either of our
                    offices. Many clients prefer video calls for convenience.
                  </>
                ) : (
                  faq.answer
                )}
