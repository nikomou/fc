              ...
              <section className="mb-16">
                <div className="bg-gray-50 rounded-xl p-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    >
                      <h4 className="font-medium text-foreground-dark group-hover:text-accent">Add Custom CSS to Shopify</h4>
                      <p className="text-sm text-foreground">Style your theme with custom CSS</p>
                    </Link>
                    <Link
