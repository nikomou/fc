...
const guideCategories = [
  {
    ...
    guides: [
      ...
      { title: "How to Set Up Shopify Taxes", href: "/guides/how-to-set-up-shopify-taxes", readTime: "12 min" },
  ...
  },
  {
    ...
    guides: [
      { title: "How to Add Products to Shopify", href: "/guides/how-to-add-products-to-shopify", readTime: "14 min" },
      { title: "How to Create Shopify Collections", href: "/guides/how-to-create-shopify-collections", readTime: "11 min" },
      { title: "How to Set Up Shopify Product Variants", href: "/guides/how-to-set-up-shopify-product-variants", readTime: "10 min" },
      { title: "How to Create Shopify Product Bundles", href: "/guides/how-to-create-shopify-product-bundles", readTime: "14 min" },
      { title: "How to Import Products to Shopify", href: "/guides/how-to-import-products-to-shopify", readTime: "18 min" },
      { title: "How to Manage Shopify Inventory", href: "/guides/how-to-manage-shopify-inventory", readTime: "15 min" },
  ...
  },
  {
    ...
    guides: [
      { title: "How to Optimise Shopify Product Pages for SEO", href: "/guides/how-to-optimise-shopify-product-pages-for-seo", readTime: "15 min" },
      { title: "How to Add Schema Markup to Shopify", href: "/guides/how-to-add-schema-markup-to-shopify", readTime: "18 min" },
      { title: "How to Create Shopify Redirects", href: "/guides/how-to-create-shopify-redirects", readTime: "12 min" },
      { title: "How to Write Shopify Meta Descriptions", href: "/guides/how-to-write-shopify-meta-descriptions", readTime: "13 min" },
      { title: "How to Structure Shopify URLs for SEO", href: "/guides/how-to-structure-shopify-urls-for-seo", readTime: "12 min" },
      { title: "How to Optimise Shopify Images for SEO", href: "/guides/how-to-optimise-shopify-images-for-seo", readTime: "14 min" },
  ...
  },
  {
    ...
    guides: [
      ...
      { title: "How to Optimise Shopify Product Images", href: "/guides/how-to-optimise-shopify-product-images", readTime: "14 min" },
      { title: "How to Remove Unused Shopify App Code", href: "/guides/how-to-remove-unused-shopify-app-code", readTime: "12 min" },
  ...
  },
  {
    ...
    guides: [
      { title: "How to Reduce Shopify Cart Abandonment", href: "/guides/how-to-reduce-shopify-cart-abandonment", readTime: "16 min" },
      { title: "How to Add Trust Badges to Shopify", href: "/guides/how-to-add-trust-badges-to-shopify", readTime: "12 min" },
      { title: "How to Create Urgency on Shopify", href: "/guides/how-to-create-urgency-on-shopify", readTime: "14 min" },
      { title: "How to Add Reviews to Shopify", href: "/guides/how-to-add-reviews-to-shopify", readTime: "13 min" },
  ...
  },
  {
    ...
    guides: [
      ...
      { title: "How to Connect Shopify to Google Merchant Center", href: "/guides/how-to-connect-shopify-to-google-merchant-center", readTime: "16 min" },
      { title: "How to Set Up Klaviyo on Shopify", href: "/guides/how-to-set-up-klaviyo-on-shopify", readTime: "18 min" },
      { title: "How to Create Shopify Email Campaigns", href: "/guides/how-to-create-shopify-email-campaigns", readTime: "15 min" },
      { title: "How to Set Up Shopify Abandoned Cart Emails", href: "/guides/how-to-set-up-shopify-abandoned-cart-emails", readTime: "14 min" },
      { title: "How to Read Shopify Analytics", href: "/guides/how-to-read-shopify-analytics", readTime: "15 min" },
      { title: "How to Track Shopify Conversions", href: "/guides/how-to-track-shopify-conversions", readTime: "16 min" },
  ...
  },
  {
    ...
    guides: [
      { title: "How to Create Shopify Discount Codes", href: "/guides/how-to-create-shopify-discount-codes", readTime: "13 min" },
      { title: "How to Run Shopify Flash Sales", href: "/guides/how-to-run-shopify-flash-sales", readTime: "16 min" },
  ...
  },
  {
    ...
    guides: [
      { title: "How to Customise Shopify Theme", href: "/guides/how-to-customise-shopify-theme", readTime: "16 min" },
      { title: "How to Add Custom Fonts to Shopify", href: "/guides/how-to-add-custom-fonts-to-shopify", readTime: "10 min" },
      { title: "How to Add Custom CSS to Shopify", href: "/guides/how-to-add-custom-css-to-shopify", readTime: "12 min" },
      { title: "How to Create Shopify Landing Pages", href: "/guides/how-to-create-shopify-landing-pages", readTime: "14 min" },
  ...
  },
  {
    ...
    guides: [
      ...
      { title: "How to Offer Free Shipping on Shopify", href: "/guides/how-to-offer-free-shipping-on-shopify", readTime: "13 min" },
      { title: "How to Set Up Shopify Order Tracking", href: "/guides/how-to-set-up-shopify-order-tracking", readTime: "11 min" },
  ...
  },
  {
    ...
    guides: [
      { title: "How to Sell Internationally on Shopify", href: "/guides/how-to-sell-internationally-on-shopify", readTime: "16 min" },
      { title: "How to Set Up Shopify Markets", href: "/guides/how-to-set-up-shopify-markets", readTime: "15 min" },
  ...
  },
  {
    ...
    guides: [
      ...
      { title: "How to Create Wholesale Pricing on Shopify", href: "/guides/how-to-create-wholesale-pricing-on-shopify", readTime: "16 min" },
      { title: "How to Set Up Trade Accounts on Shopify", href: "/guides/how-to-set-up-trade-accounts-on-shopify", readTime: "14 min" },
  ...
  },
  {
    ...
    guides: [
      { title: "How to Secure Your Shopify Store", href: "/guides/how-to-secure-your-shopify-store", readTime: "16 min" },
      { title: "How to Make Shopify GDPR Compliant", href: "/guides/how-to-make-shopify-gdpr-compliant", readTime: "20 min" },
  ...
  },
  {
    ...
    guides: [
      ...
      { title: "How to Connect Shopify to Accounting Software", href: "/guides/how-to-connect-shopify-to-accounting-software", readTime: "16 min" },
      { title: "How to Set Up Shopify POS", href: "/guides/how-to-set-up-shopify-pos", readTime: "15 min" },
