          ...
          {faqs.map((faq, index) => (
            ...
            >
              ...
              <p className="text-foreground">
                {index === 1 ? (
                  <>
                    Absolutely! While we work remotely with Newcastle clients,
                    we have physical offices in{" "}
                    <Link
                    ...
                    . We&apos;re happy to arrange face-to-face meetings at either
                    location, or our team can travel to Newcastle for key project
                    milestones.
                  </>
                ) : (
                  faq.answer
